...
def _windows_msvc_impl(ctx):
    ...
    cxx_builtin_include_directories = [
        "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/",
        ...
        env_sets = [
            env_set(
                ...
                env_entries = [
                    ...
                    env_entry(key = "TMP", value = "c:\\t"),
                    env_entry(key = "TEMP", value = "c:\\t"),
                ],
            ),
        ],
...
def _windows_msys_mingw_impl(ctx):
    ...
    gcc_env_feature = feature(
        ...
        env_sets = [
            env_set (
                ...
                env_entries = [
                    env_entry(key = "PATH", value = "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin")
                ],
            ),
        ],
    )
 ...
 "-lstdc++"
    ...
    cxx_builtin_include_directories = [
        "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/",
        "C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\VC\\INCLUDE",
        "C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\VC\\ATLMFC\\INCLUDE",
        "C:\\Program Files (x86)\\Windows Kits\\10\\include\\10.0.15063.0\\ucrt",
        "C:\\Program Files (x86)\\Windows Kits\\NETFXSDK\\4.6.1\\include\\um",
    ...
    make_variables = []
    tool_paths = [
        tool_path (name= "ar", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/ar"),
        tool_path (name= "compat-ld", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/ld"),
        tool_path (name= "cpp", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/cpp"),
        tool_path (name= "dwp", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/dwp"),
        tool_path (name= "gcc", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/gcc"),
        tool_path (name= "gcov", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/gcov"),
        tool_path (name= "ld", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/ld"),
        tool_path (name= "nm", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/nm"),
        tool_path (name= "objcopy", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/objcopy"),
        tool_path (name= "objdump", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/objdump"),
        tool_path (name= "strip", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/mingw64/bin/strip"),
...
def _impl(ctx):
    ...
    tool_paths = [
        tool_path (name= "ar", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/ar"),
        tool_path (name= "compat-ld", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/ld"),
        tool_path (name= "cpp", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/cpp"),
        tool_path (name= "dwp", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/dwp"),
        tool_path (name= "gcc", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/gcc"),
        tool_path (name= "gcov", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/gcov"),
        tool_path (name= "ld", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/ld"),
        tool_path (name= "nm", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/nm"),
        tool_path (name= "objcopy", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/objcopy"),
        tool_path (name= "objdump", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/objdump"),
        tool_path (name= "strip", path= "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin/strip"),
    ...
    gcc_env_feature = feature(
        ...
        env_sets = [
            env_set (
                ...
                env_entries = [
                    env_entry(key = "PATH", value = "c:/users/chebotarev_v/scoop/apps/msys2/current/usr/bin")
                ],
            ),
        ],
    )
